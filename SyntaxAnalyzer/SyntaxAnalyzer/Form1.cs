...
namespace SyntaxAnalyzer
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Вариант 23 \nНомер задания: 311311 \nРазработал: Третьяков К.С.", "О программе", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    ...
    this);
        ...
        private void синтаксическийАнализToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            richTextBox3.Text += "Неверный синтаксис \n";
            richTextBox3.Text += "Синтаксический анализ завершен! \n";
        }
        ...
        private void семантическийАнализToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            richTextBox3.Text += "Допущена ошибка\n";
            richTextBox3.Text += "Семантический анализ завершён!\n";
        }
        ...
        private void лексическийАнализToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            richTextBox16.Visible = true;
        }
